...
ActiveRecord::Schema[7.0].define(version: 2022_11_22_110814) do
  ...
  create_table "dragons", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owner_id"], name: "index_dragons_on_owner_id"
  end
  ...
  add_foreign_key "dragons", "users", column: "owner_id"
end
